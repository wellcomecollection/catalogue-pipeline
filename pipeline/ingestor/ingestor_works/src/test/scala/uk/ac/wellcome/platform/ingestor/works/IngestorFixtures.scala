...
trait IngestorFixtures extends ElasticIndexerFixtures with PipelineStorageStreamFixtures {
  this: Suite =>
  ...
  def withWorkerService[R](queue: Queue,
    ...
    val config = PipelineStorageConfig(batchSize = 100, flushInterval = 1 second, parallelism = 10)
