...
/** This is information we put in the Elasticsearch index because it's useful when we're debugging
  * the pipeline, but not something we'd want to display in public API responses.
  */
