...
class SierraFormerFrequencyTest
    extends AnyFunSpec
    with Matchers
  ...
  it("gets multiple instances of 321") {
      ...
      varFields = List(
        VarField(
          ...
          subfields = List(
            Subfield(
              tag = "a",
              content = "Former frequency: Monthly, 1809-1819, 1822-1827"
            )
          )
        ),
        VarField(
    ...
    SierraFormerFrequency(bibData) shouldBe List(
      "Former frequency: Monthly, 1809-1819, 1822-1827",
      "Former frequency: Weekly, 1801-1808"
    )
  }
}
