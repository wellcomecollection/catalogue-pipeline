...
trait SierraUniformTitle extends MarcUtils {
  ...
  def getUniformTitle(bibData: SierraBibData): Option[String] =
    getUniformTitleFromField(bibData, "240") orElse getUniformTitleFromField(bibData, "130")

  private def getUniformTitleFromField(bibData: SierraBibData, tag: String): Option[String] =
