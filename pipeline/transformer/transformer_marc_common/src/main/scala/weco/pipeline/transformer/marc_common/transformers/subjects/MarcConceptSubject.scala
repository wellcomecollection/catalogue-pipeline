...
//
trait MarcConceptSubject extends MarcSubject with MarcCommonLabelSubdivisions {
  ...
  protected def getPrimaryTypeConcepts(
    field: MarcField,
...
object MarcConceptSubject extends MarcConceptSubject
