...
/** Extract a provenance[1] element as a Note, including the att.datable.w3c[2] attributes expressed
  * as prose in the Note text.
  *   1. https://www.tei-c.org/release/doc/tei-p5-doc/en/html/ref-provenance.html, 2.
