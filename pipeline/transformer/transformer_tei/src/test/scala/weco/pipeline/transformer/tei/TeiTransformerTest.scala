    ...
    work.value shouldBe
      Work.Visible[Source](
        ...
        data = WorkData[Unidentified](
          ...
          subjects = List(Subject(id = Identifiable(SourceIdentifier(IdentifierType.LCSubjects, "Subject","sh85083116" )), label = "Medicine, Arab", concepts = List(Concept(label ="Medicine, Arab")))),
