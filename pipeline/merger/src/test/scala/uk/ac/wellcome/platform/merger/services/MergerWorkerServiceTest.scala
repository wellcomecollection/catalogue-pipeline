      ...
      case (vhs, QueuePair(queue, dlq), senders, metrics) =>
        ...
        eventually {
          ...
          senders.works
            ...
            work1.transition[Merged]((Some(latestUpdate), 1)),
            work2.transition[Merged]((Some(latestUpdate), 1)),
            work3.transition[Merged]((Some(latestUpdate), 1))
          )
