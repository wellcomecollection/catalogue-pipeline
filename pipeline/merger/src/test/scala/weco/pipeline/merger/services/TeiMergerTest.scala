...
import weco.catalogue.internal_model.work.{InternalWork, Work, WorkData}
...
class TeiMergerTest extends AnyFunSpec with SourceWorkGenerators with MergeCandidateGenerators with Matchers {
