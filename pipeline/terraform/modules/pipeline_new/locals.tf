...
locals {
  ...
  es_works_identified_index   = "works-identified-${var.index_dates.identified}"
  es_works_denormalised_index = "works-denormalised-${var.index_dates.merged}"
  es_works_indexed_index      = "works-indexed-${var.index_dates.works}"
  es_images_initial_index     = "images-initial-${var.index_dates.initial}"
  es_images_augmented_index   = "images-augmented-${var.index_dates.augmented}"
  es_images_indexed_index     = "images-indexed-${var.index_dates.images}"
  es_concepts_indexed_index   = "concepts-indexed-${var.index_dates.concepts}"
