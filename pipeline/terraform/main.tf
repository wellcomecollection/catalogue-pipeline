module "catalogue_pipeline_20200908" {
  source = "./stack"

  namespace = "catalogue-20200908"
  ...
  # Elasticsearch
  es_works_index  = "works-20200908"
  es_images_index = "images-20200908"
...
module "catalogue_pipeline_20200910" {
  source = "./stack"

  namespace = "catalogue-20200910"
  ...
  # Elasticsearch
  es_works_index  = "works-20200910"
  es_images_index = "images-20200910"
