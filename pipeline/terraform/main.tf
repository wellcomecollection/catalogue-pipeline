module "catalogue_pipeline_20200626" {
  source = "./stack"

  namespace = "catalogue-20200626"
  ...
  # Elasticsearch
  es_works_index  = "works-20200626"
  es_images_index = "images-20200626"
...
module "catalogue_pipeline_20200701-2" {
  ...
  # Elasticsearch
  es_works_index  = "works-20200701-2"
  es_images_index = "images-20200701-2"
