...
//module "catalogue_pipeline_20191121" {
//  source = "./stack_2"
//
//  namespace = "catalogue-20191121"
//
...
//  vhs_sierra_sourcedata_table_name  = "${local.vhs_sierra_sourcedata_table_name}"
//
////  s3_storage_read_policy = ""
//  storage_bucket_name = "wellcomecollection-storage"
//}