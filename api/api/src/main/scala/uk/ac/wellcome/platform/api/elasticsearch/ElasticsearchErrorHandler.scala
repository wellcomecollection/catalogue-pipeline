...
object ElasticsearchErrorHandler extends Logging {
  ...
  private def userError(message: String,
    ...
    DisplayError(ErrorVariant.http400, description = Some(message))
  }
  ...
  private def notFound(message: String,
    ...
    DisplayError(ErrorVariant.http404, description = Some(message))
  }
  ...
  private def serverError(message: String,
    ...
    DisplayError(ErrorVariant.http500, description = None)
  }
}
