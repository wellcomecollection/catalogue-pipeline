                ...
                "results": [
                  {
                    ...
                    "title": "${matchingWork1.data.title}",
                    "alternativeTitles": [],
                  ...
                  },
                  {
                    ...
                    "title": "${matchingWork2.data.title}",
                    "alternativeTitles": [],
