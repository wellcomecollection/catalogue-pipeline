    ...
    withApi {
      case (indexV2, routes) =>
        val work1Depth1 = createIdentifiedWorkWith(
          canonicalId = "1",
          collection = Some(Collection("/depth1", CollectionLevel.Collection))
        )
        ...
        val work3Depth2 = createIdentifiedWorkWith(
          canonicalId = "3",
          collection =
            Some(Collection("/depth1/depth2", CollectionLevel.Series))
        )
        val work4Depth3 = createIdentifiedWorkWith(
          canonicalId = "4",
          collection =
            Some(Collection("/depth1/depth2/depth3", CollectionLevel.Item))
        )
