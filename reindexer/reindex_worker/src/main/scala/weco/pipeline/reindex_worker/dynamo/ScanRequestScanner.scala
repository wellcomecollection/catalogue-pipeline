...
/** Implements a wrapper for DynamoDB Scan operations using a ScanSpec.
  *
  * This wrapper provides a list of JSON strings, which can be sent directly to a downstream
  * application.
  *
  * This is based on https://alexwlchan.net/2018/08/parallel-scan-scanamo/, although the APIs have
