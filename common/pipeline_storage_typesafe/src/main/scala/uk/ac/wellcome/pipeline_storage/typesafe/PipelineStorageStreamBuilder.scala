...
import uk.ac.wellcome.pipeline_storage.{Indexer, PipelineStorageConfig, PipelineStorageStream}
...
object PipelineStorageStreamBuilder {
  ...
  def buildPipelineStorageStream[T, D, MsgDestination](sqsStream: SQSStream[T], indexer: Indexer[D], messageSender: MessageSender[MsgDestination])(config: Config)(implicit ec: ExecutionContext): PipelineStorageStream[T, D, MsgDestination] = {
