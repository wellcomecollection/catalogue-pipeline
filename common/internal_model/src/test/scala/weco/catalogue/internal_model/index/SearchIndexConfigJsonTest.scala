...
class SearchIndexConfigJsonTest
  ...
  def assertIndexConfigIsEquivalent(
    ...
    val fileMapping: String = fileJson.downField("mappings").focus.value.spaces2
    val fileSettings: String = fileJson.downField("settings").focus.value.spaces2
    /*
  ...
  private def getAnalysisSettingsOnly(
    ...
    val filteredJson = indexJson
      ...
      .up
    filteredJson.focus.value.spaces2
  }
