...
import uk.ac.wellcome.models.work.internal.{ProductionEvent, Period, Place, InstantRange}
    ...
    Marc008Parser("790922s1757    enk||||      o00||||eng ccam   ") shouldBe
      Some(ProductionEvent(
        ...
        dates = List(
          Period(
            label = "1757",
            range = Some(InstantRange(LocalDate of (1757, 1, 1), 
    ...
    Marc008Parser("      s2003    enk050        0   vneng dngm a ") shouldBe
      Some(ProductionEvent(
        ...
        dates = List(
          Period(
            label = "2003",
            range = Some(InstantRange(LocalDate of (2003, 1, 1), 
    ...
    Marc008Parser("030623e19081121ua                k0eng dnkm a ") shouldBe
      Some(ProductionEvent(
        ...
        dates = List(
          Period(
            label = "1908/11/21",
            range = Some(InstantRange(LocalDate of (1908, 11, 21), 
    ...
    Marc008Parser("030818q16001699                  kn    dnka a ") shouldBe
      Some(ProductionEvent(
        ...
        dates = List(
          Period(
            label = "1600-1699",
            range = Some(InstantRange(LocalDate of (1600, 1, 1), 
