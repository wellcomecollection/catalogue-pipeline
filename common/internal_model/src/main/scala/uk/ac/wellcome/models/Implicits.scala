...
object Implicits {
  ...
  implicit val _dec40: Decoder[Contributor[IdState.Minted]] =
    deriveConfiguredDecoder
  implicit val _dec41: Decoder[ImageData[IdState.Identifiable]] =
    deriveConfiguredDecoder
  implicit val _dec42: Decoder[ImageData[IdState.Identified]] =
    deriveConfiguredDecoder
  ...
  implicit val _dec61: Decoder[Work[WorkState.Identified]] =
    deriveConfiguredDecoder
  implicit val _dec62: Decoder[SourceWorks[DataState.Identified]] =
    deriveConfiguredDecoder
  implicit val _dec63: Decoder[SourceWorks[DataState.Unidentified]] =
    deriveConfiguredDecoder
  implicit val _dec64: Decoder[ImageSource[DataState.Identified]] =
    deriveConfiguredDecoder
  implicit val _dec65: Decoder[ImageSource[DataState.Unidentified]] =
    deriveConfiguredDecoder
  implicit val _dec66: Decoder[Image[ImageState.Initial]] =
    deriveConfiguredDecoder
  implicit val _dec67: Decoder[Image[ImageState.Augmented]] =
    deriveConfiguredDecoder
  implicit val _dec68: Decoder[Image[ImageState.Identified]] =
    deriveConfiguredDecoder
  ...
  implicit val _enc40: Encoder[Contributor[IdState.Minted]] =
    deriveConfiguredEncoder
  implicit val _enc41: Encoder[ImageData[IdState.Identifiable]] =
    deriveConfiguredEncoder
  implicit val _enc42: Encoder[ImageData[IdState.Identified]] =
    deriveConfiguredEncoder
  implicit val _enc43: Encoder[CollectionPath] =
    deriveConfiguredEncoder
  implicit val _enc44: Encoder[WorkData[DataState.Unidentified]] =
    deriveConfiguredEncoder
  implicit val _enc45: Encoder[WorkData[DataState.Identified]] =
    deriveConfiguredEncoder
  implicit val _enc46: Encoder[Work.Visible[WorkState.Source]] =
    deriveConfiguredEncoder
  implicit val _enc47: Encoder[Work.Visible[WorkState.Merged]] =
    deriveConfiguredEncoder
  implicit val _enc48: Encoder[Work.Visible[WorkState.Denormalised]] =
    deriveConfiguredEncoder
  implicit val _enc49: Encoder[Work.Visible[WorkState.Identified]] =
    deriveConfiguredEncoder
  implicit val _enc50: Encoder[Work.Invisible[WorkState.Source]] =
    deriveConfiguredEncoder
  implicit val _enc51: Encoder[Work.Invisible[WorkState.Merged]] =
    deriveConfiguredEncoder
  implicit val _enc52: Encoder[Work.Invisible[WorkState.Denormalised]] =
    deriveConfiguredEncoder
  implicit val _enc53: Encoder[Work.Invisible[WorkState.Identified]] =
    deriveConfiguredEncoder
  implicit val _enc54: Encoder[Work.Redirected[WorkState.Source]] =
    deriveConfiguredEncoder
  implicit val _enc55: Encoder[Work.Redirected[WorkState.Merged]] =
    deriveConfiguredEncoder
  implicit val _enc56: Encoder[Work.Redirected[WorkState.Denormalised]] =
    deriveConfiguredEncoder
  implicit val _enc57: Encoder[Work.Redirected[WorkState.Identified]] =
    deriveConfiguredEncoder
  implicit val _enc58: Encoder[Work[WorkState.Source]] =
    deriveConfiguredEncoder
  implicit val _enc59: Encoder[Work[WorkState.Merged]] =
    deriveConfiguredEncoder
  implicit val _enc60: Encoder[Work[WorkState.Denormalised]] =
    deriveConfiguredEncoder
  implicit val _enc61: Encoder[Work[WorkState.Identified]] =
    deriveConfiguredEncoder
  implicit val _enc62: Encoder[SourceWorks[DataState.Identified]] =
    deriveConfiguredEncoder
  implicit val _enc63: Encoder[SourceWorks[DataState.Unidentified]] =
    deriveConfiguredEncoder
  implicit val _enc64: Encoder[ImageSource[DataState.Identified]] =
    deriveConfiguredEncoder
  implicit val _enc65: Encoder[ImageSource[DataState.Unidentified]] =
    deriveConfiguredEncoder
  implicit val _enc66: Encoder[Image[ImageState.Initial]] =
    deriveConfiguredEncoder
  implicit val _enc67: Encoder[Image[ImageState.Augmented]] =
    deriveConfiguredEncoder
  implicit val _enc68: Encoder[Image[ImageState.Identified]] =
    deriveConfiguredEncoder
