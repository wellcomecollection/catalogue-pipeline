...
object Implicits {
  ...
  implicit val _dec73: Decoder[DigitalLocationType] = LocationType.digitalLocationTypeDecoder
  implicit val _dec74: Decoder[PhysicalLocationType] = LocationType.physicalLocationTypeDecoder
  ...
  implicit val _enc73: Encoder[DigitalLocationType] = LocationType.digitalLocationTypeEncoder
  implicit val _enc74: Encoder[PhysicalLocationType] = LocationType.physicalLocationTypeEncoder
}
