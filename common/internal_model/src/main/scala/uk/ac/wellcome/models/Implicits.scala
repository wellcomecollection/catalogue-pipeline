...
object Implicits {
  ...
  implicit val _dec21: Decoder[AbstractAgent[Unminted]] = deriveConfiguredDecoder
  ...
  implicit val _dec27: Decoder[AbstractConcept[Unminted]] = deriveConfiguredDecoder
  implicit val _dec28: Decoder[AbstractConcept[Minted]] = deriveConfiguredDecoder
  implicit val _dec29: Decoder[AbstractRootConcept[Unminted]] = deriveConfiguredDecoder
  implicit val _dec30: Decoder[AbstractRootConcept[Minted]] = deriveConfiguredDecoder
  ...
  implicit val _dec35: Decoder[ProductionEvent[Unminted]] = deriveConfiguredDecoder
  implicit val _dec36: Decoder[ProductionEvent[Minted]] = deriveConfiguredDecoder
  ...
  implicit val _dec41: Decoder[WorkData[Unminted, Identifiable]] = deriveConfiguredDecoder
  implicit val _dec42: Decoder[WorkData[Minted, Identified]] = deriveConfiguredDecoder
  implicit val _dec43: Decoder[UnidentifiedWork] = deriveConfiguredDecoder
  implicit val _dec44: Decoder[UnidentifiedInvisibleWork] = deriveConfiguredDecoder
  implicit val _dec45: Decoder[IdentifiedWork] = deriveConfiguredDecoder
  implicit val _dec46: Decoder[UnidentifiedRedirectedWork] = deriveConfiguredDecoder
  ...
  implicit val _dec51: Decoder[UnmergedImage[Identifiable]] = deriveConfiguredDecoder
  implicit val _dec52: Decoder[UnmergedImage[Identified]] = deriveConfiguredDecoder
  implicit val _dec53: Decoder[MergedImage[Identifiable]] = deriveConfiguredDecoder
  implicit val _dec54: Decoder[MergedImage[Identified]] = deriveConfiguredDecoder
  implicit val _dec55: Decoder[BaseImage[Identifiable]] = deriveConfiguredDecoder
  implicit val _dec56: Decoder[BaseImage[Identified]] = deriveConfiguredDecoder
  ...
  implicit val _enc21: Encoder[AbstractAgent[Unminted]] = deriveConfiguredEncoder
  ...
  implicit val _enc27: Encoder[AbstractConcept[Unminted]] = deriveConfiguredEncoder
  implicit val _enc28: Encoder[AbstractConcept[Minted]] = deriveConfiguredEncoder
  implicit val _enc29: Encoder[AbstractRootConcept[Unminted]] = deriveConfiguredEncoder
  implicit val _enc30: Encoder[AbstractRootConcept[Minted]] = deriveConfiguredEncoder
  ...
  implicit val _enc35: Encoder[ProductionEvent[Unminted]] = deriveConfiguredEncoder
  implicit val _enc36: Encoder[ProductionEvent[Minted]] = deriveConfiguredEncoder
  ...
  implicit val _enc41: Encoder[WorkData[Unminted, Identifiable]] = deriveConfiguredEncoder
  implicit val _enc42: Encoder[WorkData[Minted, Identified]] = deriveConfiguredEncoder
  implicit val _enc43: Encoder[UnidentifiedWork] = deriveConfiguredEncoder
  implicit val _enc44: Encoder[UnidentifiedInvisibleWork] = deriveConfiguredEncoder
  implicit val _enc45: Encoder[IdentifiedWork] = deriveConfiguredEncoder
  implicit val _enc46: Encoder[UnidentifiedRedirectedWork] = deriveConfiguredEncoder
  ...
  implicit val _enc51: Encoder[UnmergedImage[Identifiable]] = deriveConfiguredEncoder
  implicit val _enc52: Encoder[UnmergedImage[Identified]] = deriveConfiguredEncoder
  implicit val _enc53: Encoder[MergedImage[Identifiable]] = deriveConfiguredEncoder
  implicit val _enc54: Encoder[MergedImage[Identified]] = deriveConfiguredEncoder
  implicit val _enc55: Encoder[BaseImage[Identifiable]] = deriveConfiguredEncoder
  implicit val _enc56: Encoder[BaseImage[Identified]] = deriveConfiguredEncoder
