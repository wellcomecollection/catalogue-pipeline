...
sealed trait ImageSource[ImageId <: IdState.WithSourceIdentifier, DataId <: IdState] {
  val id: ImageId
  val ontologyType: String
}

case class SourceWorks[ImageId <: IdState.WithSourceIdentifier, DataId <: IdState](
...
case class SourceWork[ImageId <: IdState.WithSourceIdentifier, DataId <: IdState](
  id: ImageId,
