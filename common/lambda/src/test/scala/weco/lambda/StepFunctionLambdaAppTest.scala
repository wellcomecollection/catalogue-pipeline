  ...
  describe("StepFunctionLambdaApp") {
    ...
    describe("handleRequest") {
      it("processes successful requests") {
        ...
        val result = app.handleRequest(input, mockContext)
      ...
      it("handles processing failures") {
        ...
        val thrown = intercept[RuntimeException] {
          app.handleRequest(input, mockContext)
        }
      ...
      it("logs request processing") {
        ...
        // This test mainly verifies that logging doesn't cause exceptions
    ...
    describe("processRequest") {
      it("is abstract and must be implemented by subclasses") {
        ...
        val result = app.processRequest(input)
