      ...
      describe("cannot be requested") {
        it("if it needs a manual request") {
          ...
          ac should have(
            ...
            noStatus(),
            noTerms(),
            note("This item needs to be ordered manually. Please ask a member of staff, or email <a href=\"mailto:library@wellcomecollection.org\">library@wellcomecollection.org</a>."),
          )
        }
