...
object SierraRulesForRequesting {
  def apply(itemData: SierraItemData): RulesForRequestingResult =
    itemData match {
      ...
      case i if i.fixedField("88").contains("z") => NotRequestable.NoPublicReason("fixed field 88 = z")
      ...
      case i if i.fixedField("88").contains("y") =>
        NotRequestable.NoPublicReason("fixed field 88 = y")
      ...
      case i if i.fixedField("61").containsAnyOf("17", "18", "15") =>
        NotRequestable.NoPublicReason(s"fixed field 61 = ${i.fixedField("61").get}")
      ...
      case i if i.fixedField("79").contains("sepep") =>
        NotRequestable.NoPublicReason("fixed field 79 = sepep")
      ...
      case i if i.fixedField("79").containsAnyOf("rm001", "rmdda") =>
        NotRequestable.NoPublicReason(s"fixed field 79 = ${i.fixedField("79").get}")
      ...
      case i if i.fixedField("97").contains("j") =>
        NotRequestable.NoPublicReason("fixed field 97 = j")
