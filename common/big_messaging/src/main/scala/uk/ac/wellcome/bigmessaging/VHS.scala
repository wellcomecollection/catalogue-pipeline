...
class VHSInternalStore[TypedStoreLocation <: Location, T](
  ...
  indexStore: Store[Version[String, Int], TypedStoreLocation] with Maxima[String, Int],
  dataStore: TypedStore[TypedStoreLocation, T]
) extends HybridStoreWithMaxima[String, Int, TypedStoreLocation, T] {

  override val indexedStore: Store[Version[String, Int], TypedStoreLocation] with Maxima[String, Int] = indexStore
