...
def get_mock_expected_report(record_count: int, file_size: int):
    return {
...
def get_mock_expected_metric(file_size: int):
    return {
...
def verify_s3_reports(record_count: int, file_size: int):
