...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Mid-1970s-mid-1980s", date(1973, 1, 1), date(1986, 12, 31)),
        ("mid-19th century-1907", date(1830, 1, 1), date(1907, 12, 31)),
        ("mid-20th century - late 20th century", date(1930, 1, 1), date(1999, 12, 31)),
        ...
        ("c. MCML", date(1940, 1, 1), date(1959, 12, 31)),
        ("c. M.DCC.XLV.", date(1735, 1, 1), date(1754, 12, 31)),
        ("[c. MDCCL]", date(1740, 1, 1), date(1759, 12, 31)),
        ("A. C. MDCLXXXII. [1682]", date(1682, 1, 1), date(1682, 12, 31)),
        ("a. c. [1682]", date(1682, 1, 1), date(1682, 12, 31)),
        ("a.C. MDCCXXVIII. [1728]", date(1728, 1, 1), date(1728, 12, 31)),
