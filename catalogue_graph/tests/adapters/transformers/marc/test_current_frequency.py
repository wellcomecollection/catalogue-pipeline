...
def test_no_frequency(marc_record: Record) -> None:
    assert extract_current_frequency(marc_record) is None
...
def test_frequency_a(marc_record: Record) -> None:
    assert extract_current_frequency(marc_record) == "Samhain"
...
def test_frequency_b(marc_record: Record) -> None:
    assert extract_current_frequency(marc_record) == "&lt;Sept. 1991-&gt;"
...
def test_frequency_a_b(marc_record: Record) -> None:
    assert (
        extract_current_frequency(marc_record)
