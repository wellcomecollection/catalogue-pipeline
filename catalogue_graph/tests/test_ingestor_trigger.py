...
def get_mock_trigger_event(job_id: str | None):
    return IngestorTriggerLambdaEvent(
        pipeline_date="2025-01-01", index_date="2025-03-01", job_id=job_id
    )


def get_mock_loader_event(job_id: str | None, start_offset: int, end_index: int):
...
def get_mock_trigger_monitor_event(events: list):
