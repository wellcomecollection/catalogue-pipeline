...
def test_catalogue_works_transformer_edges() -> None:
    ...
    _check_edge(edges, "m4u8drnu", "s6s24vd7", WorkHasConcept(
        from_type="Work",
        to_type="Concept",
        from_id="m4u8drnu",
        to_id="s6s24vd7",
    ...
    _check_edge(edges, "ydz8wd5r", "s6s24vd8", WorkHasConcept(
        from_type="Work",
        to_type="Concept",
        from_id="ydz8wd5r",
        to_id="s6s24vd8",
    ...
    _check_edge(edges, "ydz8wd5r", "yfqryj26", WorkHasConcept(
        from_type="Work",
        to_type="Concept",
        from_id="ydz8wd5r",
        to_id="yfqryj26",
    ...
    _check_edge(edges,"ydz8wd5r", "uykuavkt", WorkHasConcept(
        from_type="Work",
        to_type="Concept",
        from_id="ydz8wd5r",
        to_id="uykuavkt",
