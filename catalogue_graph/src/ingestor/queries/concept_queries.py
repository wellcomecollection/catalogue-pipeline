...
# Ran 'related to' query in 11 seconds, retrieving 458 records.
# Ran 'field of work' query in 10 seconds, retrieving 422 records.
# Ran 'narrower than' query in 13 seconds, retrieving 843 records.
# Ran 'broader than' query in 22 seconds, retrieving 580 records.
# Ran 'people' query in 16 seconds, retrieving 183 records.
# Ran 'frequent collaborators' query in 20 seconds, retrieving 346 records.
# Ran 'related topics' query in 37 seconds, retrieving 1293 records.
# Ran 'concept' query in 14 seconds, retrieving 10000 records.
