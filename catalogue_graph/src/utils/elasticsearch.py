...
def get_client(pipeline_date: str | None = None, is_local: bool = False) -> Elasticsearch:
    config = ElasticsearchConfig() if pipeline_date is None else get_pipeline_config(pipeline_date, is_local)
