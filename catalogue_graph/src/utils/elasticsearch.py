...
def get_standard_index_name(prefix: str, pipeline_date: str | None):
...
def get_pipeline_config(pipeline_date: str, is_local: bool, api_key_name: str) -> ElasticsearchConfig:
