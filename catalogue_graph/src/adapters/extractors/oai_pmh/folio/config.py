...
# Retries for transient failures (empty bodies, transport errors, 5xx); shares
# the backoff ladder configured by FOLIO_OAI_BACKOFF_FACTOR / FOLIO_OAI_BACKOFF_MAX.
OAI_TRANSIENT_RETRIES = int(os.getenv("FOLIO_OAI_TRANSIENT_RETRIES", "3"))
