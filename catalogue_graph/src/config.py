...
MERGER_S3_PREFIX_DEFAULT = "merger"
MERGER_S3_PREFIX = os.environ.get("MERGER_S3_PREFIX", MERGER_S3_PREFIX_DEFAULT)
...
ES_IMAGES_AUGMENTED_INDEX_NAME = "images-augmented"
ES_IMAGES_INITIAL_INDEX_NAME = "images-initial"
