...
# Deleting by ID is more costly than deleting by label, so we need to reduce the batch size to make it work.
...
class BaseNeptuneClient:
    ...
    def get_total_edge_count(self) -> int:
        ...
        return self.run_open_cypher_query(query)[0]["edgeCount"]
    ...
    def get_total_node_count(self) -> int:
        ...
        return self.run_open_cypher_query(query)[0]["nodeCount"]
