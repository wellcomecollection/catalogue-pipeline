...
class TestGetTrackingInfo:
    ...
    def test_get_tracking_info_nested_prefix(self):
...
class TestGetTrackingFileContent:
    ...
    def test_get_tracking_file_content_file_exists(self, mock_boto3_client):
        mock_s3 = Mock()
    ...
    @patch('utils.tracking.boto3.client')
    def test_get_tracking_file_content_file_not_exists(self, mock_boto3_client):
        # Setup
        mock_s3 = Mock()
        mock_boto3_client.return_value = mock_s3
...
class TestRecordProcessedFile:
    def setup_method(self):
        ...
        self.mock_get_content = patch('utils.tracking._get_tracking_file_content').start()
        self.mock_s3 = Mock()
    ...
    def test_record_processed_file_new_tracking_file(self):
        tracking_info = {
            "bucket": "test-bucket",
            "key": "dev/ftp_v2/processed_files.txt",
    ...
    def test_record_processed_file_append_to_existing(self):
        tracking_info = {
            "bucket": "test-bucket",
            "key": "dev/ftp_v2/processed_files.txt",
            "filename": "new-file.xml"
...
class TestIsFileAlreadyProcessed:
    ...
    def test_is_file_already_processed_file_found(self):
        tracking_info = {
            "bucket": "test-bucket",
            "key": "dev/ftp_v2/processed_files.txt",
    ...
    def test_is_file_already_processed_file_not_found(self):
        tracking_info = {
            "bucket": "test-bucket",
            "key": "dev/ftp_v2/processed_files.txt",
    ...
    def test_is_file_already_processed_no_tracking_file(self):
        tracking_info = {
            "bucket": "test-bucket",
            "key": "dev/ftp_v2/processed_files.txt",
