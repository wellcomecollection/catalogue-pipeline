...
from fixtures import temporary_table, xml_with_one_record, xml_with_two_records, xml_with_three_records
...
def test_delete_record(temporary_table, xml_with_one_record, xml_with_two_records):
    ...
    pa_table = temporary_table.scan(selected_fields=["content"], row_filter=EqualTo("id", "ebs00002")).to_arrow()
