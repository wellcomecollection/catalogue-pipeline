...
case "$IMAGE_ID" in
  ...
  "id_minter" | "inference_manager" | "feature_inferrer" | "palette_inferrer" | "aspect_ratio_inferrer" | "matcher" | "merger" | "ingestor_images" | "ingestor_works" | "router" | "batcher" | "relation_embedder" | "transformer_calm" | "transformer_mets" | "transformer_miro" | "transformer_sierra")
