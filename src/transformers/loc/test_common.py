...
def test_remove_prefix_lookalikes():
    ...
    """
    assert remove_id_prefix("/authorities/banana/sh1234567890") == "/authorities/banana/sh1234567890"
    assert remove_id_prefix("https://id.loc.gov.uk/authorities/subjects/sh1234567890") == "https://id.loc.gov.uk/authorities/subjects/sh1234567890"
