...
import uk.ac.wellcome.platform.sierra_item_merger.store.{ItemStore, VersionExpectedConflictException}
...
) (implicit ec: ExecutionContext)extends Runnable with Logging{
