...
trait SierraItemMergerFixtures
  ...
  def withSierraWorkerService[R](
    queue: Queue,
    itemRecordStore:VersionedStore[String, Int, SierraItemRecord], sierraTransformableStore: VersionedStore[String, Int, SierraTransformable])(testWith: TestWith[(SierraItemMergerWorkerService[String], MemoryMessageSender), R]): R =
