locals {
  ...
  vhs_full_access_policy = "${data.terraform_remote_state.catalogue_infra_critical.vhs_sierra_full_access_policy}"
  vhs_table_name         = "${data.terraform_remote_state.catalogue_infra_critical.vhs_sierra_table_name}"
