...
class ItemLinkerWorkerServiceTest
  ...
  override def withWorkerService[R](queue: SQS.Queue, store: VersionedStore[SierraItemNumber, Int, LinkingRecord], messageSender: MemoryMessageSender, metrics: MemoryMetrics = new MemoryMetrics)(testWith: TestWith[SierraLinkerWorkerService[SierraItemNumber, SierraItemRecord, String], R]): R =
